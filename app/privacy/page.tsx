      ...
      <section className="py-20 md:py-32 relative overflow-hidden">
        ...
        >
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            >
              <Badge variant="secondary" className="mb-4 px-4 py-2 text-sm font-medium animate-float">
                🔒 Privacy & Security
              </Badge>
            </motion.div>
            <motion.h1 
            ...
            >
              Your privacy is important to us. Learn how we collect, use, and protect your information on Codeunia.
            </motion.p>
            <motion.div 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    >
                      ...
                      <p className="text-sm text-muted-foreground">
                        We&apos;re clear about what data we collect and how we use it for platform improvement.
                      </p>
                    </motion.div>
                    <motion.div 
                      initial={{ opacity: 0, y: 20 }}
    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-center space-y-6 mb-12">
        ...
        <h2 className="text-3xl md:text-4xl font-bold">
          Compliant with <span className="gradient-text">International Standards</span>
        </h2>
        <p className="text-xl text-muted-foreground">
          We comply with privacy laws worldwide — including Europe, California, and India — to protect our global and Indian users.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <Card className="border-0 shadow-lg card-hover bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20">
          <CardHeader>
            <div className="flex items-center space-x-3">
              ...
              <CardTitle className="text-xl">GDPR Compliance</CardTitle>
            </div>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground leading-relaxed">
              We comply with the European Union&apos;s General Data Protection Regulation (GDPR), protecting data rights such as portability, erasure, and explicit consent.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-0 shadow-lg card-hover bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950/20 dark:to-teal-950/20">
          <CardHeader>
            <div className="flex items-center space-x-3">
              ...
              <CardTitle className="text-xl">CCPA Compliance</CardTitle>
            </div>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground leading-relaxed">
              We respect California residents&apos; rights under the CCPA, including the right to know, delete, and opt out of the sale of personal data.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-0 shadow-lg card-hover bg-gradient-to-br from-orange-50 to-yellow-50 dark:from-orange-950/20 dark:to-yellow-950/20">
          <CardHeader>
            <div className="flex items-center space-x-3">
              <Shield className="h-8 w-8 text-primary" />
              <CardTitle className="text-xl">DPDPA Compliance</CardTitle>
            </div>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground leading-relaxed">
              As an Indian platform, we follow the Digital Personal Data Protection Act, 2023, giving users transparency, consent-based processing, and the right to correct or delete their data.
            </p>
          </CardContent>
        </Card>
      </div>
              ...
              <CardHeader>
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">How long we keep your information</p>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-3">
                      <h4 className="font-semibold text-primary">Account Data</h4>
                      <p className="text-sm text-muted-foreground">
                    ...
                    <div className="space-y-3">
                      <h4 className="font-semibold text-primary">Project Data</h4>
                      <p className="text-sm text-muted-foreground">
                        Project data is retained based on your settings and may be kept for historical and backup
                        purposes.
                      </p>
                    </div>
                    <div className="space-y-3">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Anonymized usage data may be retained for up to 2 years for platform improvement purposes.
                      </p>
                    </div>
                    <div className="space-y-3">
                      <h4 className="font-semibold text-primary">Communication Records</h4>
                      <p className="text-sm text-muted-foreground">
                        Support communications are retained for 3 years to maintain service quality and resolve issues.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card className="border-0 shadow-lg card-hover">
                ...
                <CardContent className="space-y-4">
                  <p className="text-muted-foreground">
                    Have questions about this privacy policy or how we handle your data? Our privacy team is here to
                    help.
                  </p>
              ...
              <Card className="border-0 shadow-lg card-hover">
                ...
                <CardContent className="space-y-4">
                  <p className="text-muted-foreground">
                    If you have concerns about how your data is being handled, please report them to us immediately.
                  </p>
        ...
        >
          <div className="max-w-3xl mx-auto space-y-8 p-8 rounded-3xl bg-background/50 dark:bg-background/80 backdrop-blur-md border border-primary/10 dark:border-primary/20 shadow-xl">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-foreground dark:text-foreground/90">
              Ready to Join Codeunia?
            </h2>
            <p className="text-xl text-muted-foreground dark:text-muted-foreground/90 leading-relaxed">
              Start coding with confidence knowing your privacy is protected by industry-leading security measures.
            </p>
